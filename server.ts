...
15. شرح وتوصيف صيدلاني مفصل للمنتج (description): شرح علمي متعمق ومفصل ومكتوب بأسلوب صيدلاني راقٍ يوضح للمستخدم ما هو هذا المنتج بالتفصيل، لماذا يستعمل، كيف يدعم صحته، وأبرز مميزاته العلاجية مقارنة بغيره.
16. آلية العمل الدوائية والفسيولوجية في الجسم (pharmacology): كيف تتفاعل المواد الفعالة مع مستقبلات الخلايا والإنزيمات في الجسم لإحداث التأثير المطلوب.
17. قائمة بأهم 4 فوائد علاجية وصحية ملموسة للمنتج (benefits).
18. المراجع العلمية الدولية المحددة التي تدعم هذه النبتة (references): مثل (WHO Monographs, German Commission E, EMA/HMPC, USP, Ebers Papyrus).`;
